...
def run_mass_for_all_lda_cases():
    ...
    #LDA Here mean AMC
    #Change here
    writer = pd.ExcelWriter("./output/Exp3-15topics-result.xlsx")
    
    #Change here
    lda_names = ["AMC_15"]#, "LDA_10", "LDA_15", "LDA_25", "LDA_50"]
    ...
    for lda_case in lda_names:
        ...
        for i in range(len(T4_size)):
            #Change here
            path = "data/Exp3_Res/T123_15topics/D4" + T4_name[i] + "_text_data/D4" + T4_name[i] + "_text_data.dtopicdist"
            print(path)
